...
import torch
from transformers import LlamaTokenizer, LlamaForCausalLM, AutoTokenizer, AutoModelForCausalLM, GenerationConfig
import transformers
# -*- coding:utf-8 -*-
import argparse
    ...
    for file_name in key_data_pairs:
        ...
        for d in tqdm(data):
            ...
            for inst, out in zip(instructions, outputs):
                ...
                # sample = model.generate(inputs.input_ids, generation_config=generation_config)
                sample = gen(inputs.input_ids, generation_config=generation_config)
...
if __name__ == "__main__":
    ...
    open_source_model = f"Phi3-mini-128K-mi"
    ...
    # breakpoint()
    model = Phi3ForCausalLM.from_pretrained(model_path, trust_remote_code=True, torch_dtype=torch.bfloat16, device_map='auto')

    minference_patch = MInference(
        "minference",
        '/home/test/test01/hyx/Phi3-mini-128K',
        config_path=None,
        starting_layer=0,
        use_snapkv=False,
        is_search=False,
